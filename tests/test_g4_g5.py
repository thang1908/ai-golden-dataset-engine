...
def test_g4_accepts_first_verified_draft():
    ...
    with client:
        assert run_g4(_image(), client) == {"caption": "A person.", "caption_vi": "Một người.", "attributes": attrs}
...
def test_g5_accepts_first_question_answer_round():
    ...
    with client:
        assert run_g5(_image(), client) == {"caption": "A person.", "caption_vi": "Một người.", "attributes": attrs}
